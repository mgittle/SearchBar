const data = [
  ...
  },
  {
    ...
    productDescription:
      "- Polyester - Authentic team crest - Mesh insert under arms - Officially licensed by the NHL - Climalite fabric sweeps sweat away from your skin - Authentic tie-down fight strap with hook-and-loop and snap closure",
    price: 189.9,
    category_id: 1,
    imgUrls: [
  ...
  },
  {
    ...
    productDescription:
      "Button snaps on back and bottom of creeper 55% Cotton/45% Polyester Long Sleeve Attached footies Machine wash Officially licensed Imported Brand: Outerstuff",
    Price: 19.97,
    category_id: 1,
    imgUrls: [
  ...
  },
  {
    ...
    productDescription:
      "Durable Hockey Stick Rack. Holds up to 15 Hockey Sticks. Hang your ice hockey skates, helmet, and gloves from the rack, too. Great way to organize your home and garage.",
    price: 19.99,
    category_id: 1,
    imgUrls: [
  ...
  },
  {
    ...
    productDescription:
      "Our customizable designs include basketball, softball, soccer, football, tennis, baseball and more. Great for Christmas, thank you, team bottles, and back to school presents. Perfect for girls, boys, tweens, teens, and adults.",
    price: 15.99,
    category_id: 1,
    imgUrls: [
  ...
  },
  {
    productId: 15,
    productName:
      "400 Card NHL Hockey Gift Set - w/ Superstars, Hall of Fame Players",
    productDescription:
      "- Any hockey collector will enjoy the variety. - Cards will span the last 30+ years! - Includes Four Hard Plastic cases perfecting for stacking and protecting the cards - 400 Assorted Hockey Cards. - Includes star cards, hall-of-famers, and other assorted cards",
    price: 23.23,
    category_id: 1,
    imgUrls: [
  ...
  },
  {
    ...
    productDescription:
      "Details Pro Tarp HD Webbing Reinforcement HD Waterproof Tarpaulin bottom D-Shape opening of main compartment Skate Pocket, Organizer Panel, Internal glove mesh pocket Dryout panel and dry flow grommets Rivet reinforced HD Dual Layer webbing",
    price: 79.0,
    category_id: 1,
    imgUrls: [
  ...
  },
  {
    productId: 17,
    productName:
      "Charlie Conway #96 Mighty Ducks Adam Banks #99 Movie Ice Hockey Jersey Green White",
    productDescription:
      "- 100% High Quality Polyester - Breathable Mesh Fabric - Sleeveless Quick Dry Jersey - Embroidery and Double Stitched Name, Number and logo - Available Colors: As seen in Pictures. Available Sizes: S-XXXL",
    price: 29.88,
    category_id: 1,
    imgUrls: [
  ...
  },
  {
    productId: 27,
    productName:
      "Pure Maple Syrup, Canada No 1 Medium,can 540ml Made in Canada",
    productDescription:
      "100% PURE MALE SYRUP NO FAT SOURCE OF IRON AND CALCIUM PURE MAPLE SYRUP MADE IN CANADA IN THE COLD WINTER.",
    price: 23.92,
    category_id: 2,
    imgUrls: [
  ...
  },
  {
    productId: 29,
    productName:
      "Tap My Trees 2145 Maple Sugaring Spile And Hook, Stainless Steel",
    productDescription:
      "Screw / Nail · Metal Used in the maple sugaring process. Fits 7/16 inch tap hole in tree. Hook is attached to spile and used to hang the sap bucket. Spile is inserted into drilled hole to transfer sap into the bucket. Bucket lid attaches to spile by inserting lid rod through hole on side of spile. - Material: Stainless Steel, Type: Spile & Hook, Pkg Qty: 1.",
    price: 3.59,
    category_id: 2,
    imgUrls: [
  ...
  },
  {
    ...
    productDescription:
      "Most associate maple syrup with pancakes, but in recent years maple syrup has begun to replace white cane sugar as a sweetener. Legend has it that the first maple syrup use was a happenstance discovery as a result of Chief Woksis, an Iroquois Indian throwing his tomahawk at a tree, after he retrieved it the next morning to go out hunting his wife saw the syrup oozing down the tree! Lucky for us she was observant, and so maple sugar use was born! This is a great glass ornament for a food themed tree!",
    price: 15.99,
    category_id: 2,
    imgUrls: [
  ...
  },
  {
    productId: 34,
    productName:
      "Crown Maple® Very Dark Color Strong Taste Maple Syrup Gallon (3.79 L) - Plastic",
    productDescription:
...

  {
    ...
    productDescription:
      "The Essential Celine Dion - Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.",
    price: 11.99,
    category_id: 3,
    imgUrls: [
...

  {
    ...
    productDescription:
      "Avril Lavigne - Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.",
    price: 8.99,
    category_id: 3,
...

  {
    ...
    productName: "Drake",
    productDescription:
      "Thank Me Later - Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.",
    price: 7.25,
    category_id: 3,
...

  {
    ...
    productDescription:
      "Songs to a Seagull - Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.",
    price: 9.99,
    category_id: 3,
    imgUrls: [
...

  {
    ...
    productDescription:
      "Bryan Addams - Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.",
    price: 9.99,
    category_id: 3,
...

  {
    ...
    productDescription:
      "Rufus Wainwright - Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.",
    price: 10.75,
    category_id: 3,
...

  {
    ...
    productDescription:
      "Shania Twain - Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.",
    price: 11.65,
    category_id: 3,
  ...
  },
  {
    ...
    productDescription:
      "Slightly oversized fit with above the hip hem. Soft and fluffy with no itch. 59% polyester, 29% acrylic, 9% wool, 3% spandex.",
    price: 110.0,
    category_id: 4,
    imgUrls: [
  ...
  },
  {
    ...
    productDescription:
      "carpet in places everyone can see - why hide my amazing artistic clawing skills? brown cats with pink ears hunt anything that moves. My left donut is missing, as is my right why use post when this sofa is here but good morning sunshine.",
    Price: 1.0,
    category_id: 4,
    imgUrls: [
  ...
  },
  {
    ...
    productDescription:
      "Double Sided box call sonic dome slate pot. Slim striker sonic dome double with bat. Cut diaphragm mouth call conditioning kit carrying case.A great collection of calls for the beginner or advanced hunter. Includes a Sonic Dome slate call and wooden striker. Includes a Mouth Call and Storage Case",
    price: 27.81,
    category_id: 5,
    imgUrls: [
  ...
  },
  {
    ...
    productDescription:
      "Easily produces tending, threatening and reassuring grunts to bring the bucks closer. Flexible ribbed tube channels sound in any direction, producing realistic, deep guttural grunts. Tone can also be changed by cupping hand over the end. Includes instructions and lanyard",
    price: 8.46,
    category_id: 5,
    imgUrls: [
  ...
  },
  {
    productId: 71,
    productName:
      "Scent Killer 546-33 Wildlife Research Supercharged Clothing Wash",
    productDescription:
      "Special unscented formula. No UV brighteners. H-E formula for use in standard machine",
    price: 11.99,
    category_id: 5,
    imgUrls: [
  ...
  },
  {
    ...
    productDescription:
      "1080P full HD resolution and automatic day/night sensor ensure crisp, vivid images and videos that provide the realistic details you need for in-depth knowledge of game animals‘ behavior characteristics. A trigger speed of 0.5 seconds with 3 continuous shots means you’re less likely to miss capturing an image of wildlife that is quickly moving across the field of view. Victure game camera takes advanced low-glow infrared LED technology and superior motion-activated sensor to produce quality black and white nighttime vision without alerting game. The easy-to-use 2.4 inch LCD screen with user-friendly navigation of image mode options, photo quality, video length, PIR interval, time lapse settings make it simple to customize your scouting specifications. Lower price and higher performance make this trail camera a perfect scouting GIFT for hunting, garden wildlife watching, farm burglar, home security and property surveillance. Using lithium batteries or 6V external power supply will keep it working longer.",
    price: 39.99,
    category_id: 5,
    imgUrls: [
  ...
  },
  {
    ...
    productDescription:
      "Wi-Fi, GPS, Geotag, E-Compass, Velocity, Altitude, Record Video/Still images 1080P HD, Day/Night Use. Capable of recording and outputting an image 1080p full HD resolution at 30fps or 720p at 60fps. Unlike traditional optical systems our electronic zoom offers incredible flexibility in the field. Geotagging has never been easier and more seamless; Record and track everywhere you've been and see it on an interactive map. Built-in Wi-Fi allows a user to connect to mobile device or a desktop computer; Use your phone as a viewfinder, upgrade to the latest firmware.Kindly refer the user manual attached below for troubleshooting steps and instructions.",
    price: 135.0,
    category_id: 5,
    imgUrls: [
      "ATN X-Sight 5-18 Smart Riflescope w/1080p Video, Night Mode, WiFi, GPS, Image Stabilization, IOS and Android Apps"
  ...
  },
  {
    ...
    productDescription:
      "4x Zoom. Field Of View: 56 Ft @ 200 Ft. 500x Ambient. Light Amplification. 32-ft Dia. & 150-ft Powerful Ir Illumination. Marine night vision monocular with lightweight, water-resistant housing. High-grade, all-glass, camera-quality objective lens with 4x magnification",
    price: 227.99,
    category_id: 5,
    imgUrls: [
  ...
  },
  {
    productId: 78,
    productName:
      "GunSkins Hunting Rifle Skin Camouflage Kit DIY Vinyl Wrap with precut Pieces",
    productDescription:
      "Made in USA. Fits any Rifle. Easy to install high-performance vinyl. Conforms to any shape. Waterproof non-reflective matte finish. Removable and leaves no residue behind",
    price: 64.99,
    category_id: 5,
    imgUrls: [
  ...
  },
  {
    productId: 79,
    productName:
      "Bear Archery Salute Ready to Hunt Compound Bow Includes Trophy Ridge Sight, Whisker Biscuit, Peep Sight, and S-Loop",
    productDescription:
      "Maximum adjustability with a peak draw range of 50 to 70 lbs. and a draw length range of 20 inches to 30 inches. Dual cam system offers a super smooth draw cycle while keeping speed and efficiency. Ready to hunt compound bow comes equipped with Trophy Ridge accessories. 7 ¼ inch brace height offers a high level of forgiveness. Weighs 4 lbs. and shoots up to 300 feet per second.",
    price: 189.99,
    category_id: 5,
    imgUrls: [
  ...
  },
  {
    productId: 82,
    productName:
      "Mossy Oak Cotton Mill 2.0 Camo Hunting Pants for Men Camouflage Clothes",
    productDescription:
  ...
  },
  {
    ...
    productDescription:
      "330gsm soft high performance insulating HEAT FLEECE fabric will keep your hands warm,Insulating layer retains warmth. Highly water resistant to keep your hands dry, HYDROSHIELD waterproof membrane specifically engineered to combat the element. Realtree Xtra camouflage print. Added palm protection for better grip and superior durability. Touchscreen compatibility, can wear gloves to touch your phone. This winter waterproof glove includes a neoprene storm guard to block the elements with a Velcro adjustable wrist strap for a comfortable fit.",
    price: 10.88,
    category_id: 5,
    imgUrls: [
  ...
  },
  {
    ...
    productDescription:
      "18 cookies per box with creamy, delicious maple syrup filling. This item contains two boxes of 18 cookies, total 36 cookies.",
    price: 14.95,
    category_id: 6,
    imgUrls: [
  ...
  },
  {
    ...
    productName: "Bannock",
    productDescription:
      "A boring variety of flat quick bread. Bannock is best not eaten unless absolutely necessary. Satisfaction not guaranteed. No refunds.",
    price: 1.23,
    category_id: 6,
    imgUrls: [
  ...
  },
  {
    ...
    productDescription:
      "Sustainably raised on a natural diet of narwhals and walruses, this polar bear meat is both good for the environment and tasty. Minimal prep required, though even the pickier eaters will love the meat when lightly roasted over an open flame.",
    price: 314159.26,
    category_id: 6,
    imgUrls: [
  ...
  },
  {
    ...
    productDescription:
      "Freshly picked fiddlehead ferns from the wilds of Canada. Nutritious and delicious.",
    price: 14.23,
    category_id: 6,
    imgUrls: [
  ...
  },
  {
    ...
    productDescription:
      "A delicious maple donut shipped directly to you from the Canadian icon, Tim Hortons.",
    price: 752.31,
    category_id: 6,
    imgUrls: [
  ...
  },
  {
    ...
    productDescription:
      "Salmon jerky is an unparalleled Canadian delicacy. This wild-smoked salmon can be enjoyed as a snack or as a meal substitute, especially for breakfast!",
    price: 37.42,
    category_id: 6,
    imgUrls: [
...

  {
    ...
    productDescription:
      "Niagra, Ontario, Canada- Amazing depth of colour and outstanding red berry flavours, particularly strawberry, lend this red Icewine to pair well with chocolate or chocolate mousse and red fruit based desserts or simply strawberries and cream!",
    price: 100.0,
    category_id: 6,
    imgUrls: [
...

  {
    ...
    productDescription:
      "The freshest caribou meat possible! (Handle with care.)",
    price: 3000.0,
    category_id: 6,
    imgUrls: [
...

  {
    ...
    productDescription:
      "Montreal-style smoked meat is a type of kosher-style deli meat product made by salting and curing beef brisket with spices. The brisket is allowed to absorb the flavours over a week, is then hot smoked to cook through, and finally is steamed to completion.",
    price: 18.23,
    category_id: 6,
    imgUrls: [
...

  {
    ...
    productDescription:
      "Unlike their New York counter parts each bagel is boiled in honey water, and cooked in a wood fired oven that was designed to both cook and flavor the bagel. What comes out of  this process is a chewy, slightly sweet bagel that is incomparable to any other bagel around!",
    price: 23.5,
    category_id: 6,
    imgUrls: [
...

  {
    ...
    productDescription:
      "Seasoned pork, beef, and veal in a pastry shell. Simply bake and serve.",
    price: 5.0,
    category_id: 6,
    imgUrls: [
...

  {
    ...
    productDescription:
      "Nanaimo bars have a crumb base, custard filling, and chocolate topping. This layered Canadian dessert can be flavoured with mint or coconut and is best served on its own at room temperature.",
    price: 7.0,
    category_id: 6,
    imgUrls: [
  ...
  },
  {
    ...
    productDescription:
      "Back bacon is a traditional British style of round, lean bacon cut from the pork loin. Canadian bacon, or peameal bacon, is back bacon rolled in cornmeal.",
    price: 8.49,
    category_id: 6,
    imgUrls: [
  ...
  },
  {
    ...
    productDescription:
      "One Large Bag Authentic, Delicious, and Fresh Ketchup Chips imported from Canada and delivered to your door! Quality and Freshness guaranteed. Expiration date clearly labelled and guaranteed to be shipped with valid expiry date or your money back. Bold, and full of rich flavor Crunchy Snack time delight",
    price: 10.97,
    category_id: 6,
    imgUrls: [
  ...
  },
  {
    ...
    productDescription:
      "St Hubert Poutine Gravy mix is a delicious sauce which is used to make the famous Canadian dish Poutine.",
    price: 6.27,
    category_id: 6,
    imgUrls: [
